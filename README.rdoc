...
==1) Run Simploy on Your Build Server
  ...
  java Simploy compileCommand testsRootFolder deployCommand [password]
...
On Github that's in "Admin > Service Hooks > Post-Receive URL". Everytime Github receives a push in YourProject it will call that URL.
